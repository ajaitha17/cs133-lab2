...
public class TupleDesc implements Serializable {
    ...
    public int fieldNameToIndex(String name) throws NoSuchElementException {
        ...
        String fieldName;
        for(i=0;i<l;i++) {
            fieldName = fields.get(i).fieldName;
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        int i,l = td2.fields.size();
        for(i=0;i<l;i++) {
            td1.fields.add(td2.fields.get(i));
        }
        return null;
    }
    ...
    public boolean equals(Object o) {
        ArrayList<TDItem> ob = (ArrayList<TDItem>) o;
        int s1 = this.fields.size(), s2 = ob.size();
        if(s1 != s2)
            return false;
        int i;
        for(i=0;i<s1;i++) {
            TDItem t1 = fields.get(i), t2 = ob.get(i);
            if(!t1.fieldName.equals(ob.get(i).fieldName) || !t1.fieldType.equals(ob.get(i).fieldType))
                return false;
        }
        return true;
    }
